                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button className="text-primary/50 hover:text-primary transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary rounded-full outline-none" aria-label="About compatibility index">
                        <Info size={16} />
                      </button>
                    </TooltipTrigger>
